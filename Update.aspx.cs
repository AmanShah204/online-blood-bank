...
public partial class Update : System.Web.UI.Page
{
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        con.Open();
        SqlCommand cmd = new SqlCommand("update Donor set Firstname='" + TextBox1.Text + "',LastName='" + TextBox2.Text + "',Password='" + TextBox3.Text + "',ConPassword='" + TextBox4.Text + "',Age='" + TextBox5.Text + "',Weight='" + TextBox6.Text + "',Gender='" + DropDownList1.SelectedValue + "',BloodGroup='" + DropDownList5.SelectedValue + "',State='" + DropDownList2.SelectedValue + "',City='" + DropDownList3.SelectedValue + "',Location='" + DropDownList4.SelectedValue + "',Address='" + TextBox7.Text + "',Pin='" + TextBox8.Text + "',PhoneM='" + TextBox9.Text + "',PhoneR='" + TextBox10.Text + "',PhoneO='" + TextBox11.Text + "',LastDonated='" + TextBox12.Text + "',Message='" + TextBox13.Text + "' where Email='" + TextBox14.Text + "'", con);
        cmd.ExecuteNonQuery();
        con.Close();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        DropDownList2.SelectedValue = Session["state"].ToString();
        DropDownList3.Items.Add(Session["city"].ToString());
        DropDownList4.Items.Add(Session["loc"].ToString());
        TextBox14.Text = Session["email"].ToString();
        TextBox5.Text = Session["age"].ToString();
        TextBox6.Text = Session["weight"].ToString();
        DropDownList1.SelectedValue = Session["gen"].ToString();
        DropDownList5.SelectedValue = Session["blood"].ToString();
        TextBox7.Text = Session["add"].ToString();
        TextBox8.Text = Session["pin"].ToString();
        TextBox9.Text = Session["PM"].ToString();
        TextBox10.Text = Session["PR"].ToString();
        TextBox11.Text = Session["PO"].ToString();
        TextBox12.Text = Session["LD"].ToString();
        TextBox13.Text = Session["msg"].ToString();
    }
}